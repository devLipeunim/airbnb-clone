...
export const locationsTab = [
  ...
  { id: 2, label: "Bed & Breakfast ", icon: <AiOutlineCoffee size={24} /> },
  { id: 3, label: "Earth Homes", icon: <RiEarthquakeFill size={24} /> },
  { id: 4, label: "Amazing Pools", icon: <FaSwimmingPool size={24} /> },
  { id: 5, label: "Tropical", icon: <FaUmbrellaBeach size={24} /> },
  { id: 6, label: "Arctic", icon: <BsSnow size={24} /> },
  { id: 7, label: "Shared Homes", icon: <MdHouseSiding size={24} /> },
  { id: 8, label: "LakeFront", icon: <MdOutlineWater size={24} /> },
  { id: 9, label: "National Parks", icon: <GiKidSlide size={24} /> },
  { id: 10, label: "OMG!", icon: <GiSpaceNeedle size={24} /> },
  { id: 11, label: "Domes", icon: <GiLightningDome size={24} /> },
  { id: 12, label: "Camping", icon: <FaCampground size={24} /> },
  { id: 13, label: "A-frames", icon: <GiCampingTent size={24} /> },
  { id: 14, label: "Tiny Homes", icon: <BiHomeAlt size={24} /> },
  { id: 15, label: "Treehouses", icon: <GiEvilTree size={24} /> },
  { id: 16, label: "Surfing", icon: <GiWaveSurfer size={24} /> },
  { id: 17, label: "CountrySide", icon: <GiMountainCave size={24} /> },
  { id: 18, label: "Caves", icon: <GiCaveEntrance size={24} /> },
  { id: 19, label: "Golfing", icon: <GiGolfFlag size={24} /> },
  ...
  },
  {
    ...
    locationImages: [
      ...
      },
      {
        id: 4,
        url:
          "https://images.unsplash.com/photo-1497449493050-aad1e165?auto=format&fit=crop&w=400&h=250&q=60",
      },
    ],
